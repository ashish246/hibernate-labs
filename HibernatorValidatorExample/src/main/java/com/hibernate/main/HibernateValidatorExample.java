...
import com.hibernate.model.AnotherBean;
import com.hibernate.model.EmpIdCheck;
import com.hibernate.model.Employee;
import com.hibernate.model.EmployeeXMLValidation;
import com.hibernate.model.MyChildBean;
import com.hibernate.model.ParamValidationBean;
...
public class HibernateValidatorExample {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		ValidatorFactory hibernateVF = Validation
		...
		Set<ConstraintViolation<AnotherBean>> validationCompositionErrors = validator
		...
		ParamValidationBean paramValidationBean = new ParamValidationBean(
				"Pankaj");
		Method method = ParamValidationBean.class.getMethod("printData",
				String.class);
		Object[] params = { "1234" };
		ExecutableValidator executableValidator = validator.forExecutables();
		Set<ConstraintViolation<ParamValidationBean>> violations = executableValidator
				.validateParameters(paramValidationBean, method, params);
