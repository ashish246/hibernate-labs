...
import com.hibernate.model.Customer1;
import com.hibernate.model.Txn1;
...
public class HibernateOneToOneAnnotationMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out
					.println("Session created using annotations configuration");
			// start transaction
			...
			// Commit transaction
			tx.commit();
			System.out.println("Annotation Example. Transaction ID="
					+ txn.getId());
	...
	private static Txn1 buildDemoTransaction() {
		...
		cust.setEmail("atripathi@yahoo.com");
		cust.setName("Ashish Tripathi");
