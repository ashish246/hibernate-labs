...
public class SQLParamLoggingWithP6Spy {
	...
	public static void main(String[] args) {
		...
		// Get Employee with id with HQL Comments
		query = session.createQuery("from Employee where id= :id");
		query.setLong("id", 3).setComment("+ INDEX(employee id)");
		...
		query.setParameter("name", "Ashish Tripathi");
		query.setLong("id", 1);
